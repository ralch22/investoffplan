/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 4b98c356581df2a9b27cfd167d7a6ef1)
...
interface __BaseEnv_CloudflareEnv {
	...
	ASSETS: Fetcher;
	NEXT_PUBLIC_SITE_URL: "https://investoffplan-preview.emerge-digital.workers.dev";
	NEXT_PUBLIC_TURNSTILE_SITE_KEY: "0x4AAAAAADxBjx3Slso2Jeoo";
	NEXTJS_ENV: string;
	NEXT_PUBLIC_CATALOG_API: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_TURNSTILE_SITE_KEY" | "NEXTJS_ENV" | "NEXT_PUBLIC_CATALOG_API">> {}
}
