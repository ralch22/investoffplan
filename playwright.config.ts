...
export default defineConfig({
  ...
  webServer: {
    ...
    // queries (isCatalogDbSeeded on catalog_meta etc.) succeed instead of 500s.
    // prebuild first ensures data/catalog.json + public/data/* slices are in place
    // for the subsequent build (and static fallbacks).
