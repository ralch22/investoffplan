  ...
  "pages": {
    "compare": {
      ...
      "decision": {
        ...
        "proLowerPpsf": "Lower median sold AED/sqft (AED {ppsf} vs AED {otherPpsf}) — more built space per dirham",
        ...
        "proMoreSupply": "More live off-plan supply — {projects} projects and {units} unit options",
        ...
        "faqBetterYieldA": "{hi} — {hiYield}% gross yield vs {loYield}% in {lo}, based on median annual rent ÷ median sold price from Dubai Land Department 2025 transactions.",
        "faqCheaperQ": "Is {a} or {b} cheaper to buy in?",
        "faqCheaperA": "{cheap} — the 2025 median sold price was {cheapMedian} vs {dearMedian} in {dear}. Off-plan launches start from {cheapLaunch} in {cheap} and {dearLaunch} in {dear}.",
        "faqResellQ": "Which is easier to resell, {a} or {b}?",
        "faqResellA": "{liq} recorded {liqSales} sales in 2025 vs {thinSales} in {thin}, so it has the deeper resale market. Transaction depth is a practical proxy for how quickly you can exit at market price.",
        "faqMoreChoiceQ": "Where is there more off-plan choice right now?",
        "faqMoreChoiceA": "{supply} — {projects} live off-plan projects with {units} unit options, vs {scarceProjects} projects in {scarce}. More supply means more negotiating room but also more future competition at handover."
      },
