...
const dict = {
  ...
  "pages": {
    "compare": {
      ...
      "decision": {
        "proHigherYield": "Higher gross rental yield — {a}% vs {b}%",
        "proLowerPpsf": "Lower median sold AED/sqft (AED {a} vs AED {b}) — more built space per dirham",
        "proLowerEntry": "Lower off-plan entry price — launches from {price}",
        "proStrongerTrend": "Stronger 2025 sold-price trend ({a}% vs {b}%)",
        "proDeeperResale": "Deeper resale market — {a} sales recorded in 2025 vs {b} (easier exit)",
        ...
        "suitYieldReason": "{pct}% gross yield on real 2025 rents and sold prices{strongerClause}.",
        ...
        "suitFamiliesProfile": "Families / end-users",
        "suitFamiliesReason": "{pct}% of unit options are villas or townhouses.",
        ...
        "faqYieldQ": "Which has the better rental yield, {a} or {b}?",
        "faqYieldA": "{hi} — {hiPct}% gross yield vs {loPct}% in {lo}, based on median annual rent ÷ median sold price from Dubai Land Department 2025 transactions.",
        "faqCheaperQ": "Is {a} or {b} cheaper to buy in?",
        "faqCheaperA": "{cheap} — the 2025 median sold price was {cheapPrice} vs {dearPrice} in {dear}. Off-plan launches start from {cheapFrom} in {cheap} and {dearFrom} in {dear}.",
        ...
        "faqSupplyQ": "Where is there more off-plan choice right now?",
        "faqSupplyA": "{supply} — {projects} live off-plan projects with {units} unit options, vs {scarceProjects} projects in {scarce}. More supply means more negotiating room but also more future competition at handover."
      }
    },
