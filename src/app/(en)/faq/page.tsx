...
// Also rendered by the /ar mirror with locale="ar" so topic links + hub chrome
// stay in-locale (#252). Topic body Q&A remains EN content for v1.
            ...
            return (
              ...
              >
                ...
                <p className="mt-3 text-xs font-semibold uppercase tracking-wide text-brand">
                  {interpolate(t.answersCount, {
                    count: topic.faqs.length.toLocaleString(fmtLocale),
                  })}
                </p>
              </Link>
            );
